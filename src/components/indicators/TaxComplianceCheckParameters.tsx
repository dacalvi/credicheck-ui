...
interface TaxComplianceCheckParametersProps {
  onChange: any;
  defaultConfig: {
    segments: number[];
...
const TaxComplianceCheckParameters: React.FC<
  TaxComplianceCheckParametersProps
...
export {TaxComplianceCheckParameters};
