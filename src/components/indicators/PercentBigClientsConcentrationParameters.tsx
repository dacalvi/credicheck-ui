...
interface PercentBigClientsConcentrationParametersParametersProps {
  onChange: any;
  defaultConfig: {
    segments: number[];
...
const PercentBigClientsConcentrationParameters: React.FC<
  PercentBigClientsConcentrationParametersParametersProps
...
export {PercentBigClientsConcentrationParameters};
